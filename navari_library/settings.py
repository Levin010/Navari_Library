"""
Django settings for navari_library project.
...
ROOT_URLCONF = "navari_library.urls"
...
WSGI_APPLICATION = "navari_library.wsgi.application"
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'navari_library' / 'libraryapp' / 'static' / 'images'
